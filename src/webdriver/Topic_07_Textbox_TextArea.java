...
public class Topic_07_Textbox_TextArea {
	...
	public void TC_01_EmptyEmail_PW() {
		...
		WebElement employeetextbox = driver
		...
		WebElement confPass = driver
				.findElement(By.xpath("//label[text()='Confirm Password']/parent::div/following-sibling::div/input"));
		...
		driver.findElement(By.xpath("//label[text()='Number']/parent::div/following-sibling::div/input"))
				.sendKeys("0984-4765-322");
		driver.findElement(By.xpath("//textarea[@placeholder='Type Comments here']"))
				.sendKeys("My name is thao auto /nHello");
